...
# MacOsX Stuff
# Shameless stolen from: https://github.com/mathiasbynens/dotfiles/blob/master/.osx
...
for app in "Activity Monitor" "cfprefsd" "Dock" "Google Chrome" \
	"Finder" "SystemUIServer" "Terminal"; do
